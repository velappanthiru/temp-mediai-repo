...
import { bookMappingListColumns, bookMappingListData } from '../../utils/dummy-data';
      ...
      <div className='book-list-section'>
        ...
        <div className="flex justify-between gap-3 items-end my-4">
          ...
          <div className="flex gap-3">
            ...
            <Button type="button" color="primary" endContent={<PlusIcon />} onPress={() => router.push('/super-admin/book-mapping/add')}>
              Add New
            </Button>
          </div>
        </div>
        <Table aria-label="Example table with custom cells">
          <TableHeader columns={bookMappingListColumns}>
            {(column) => (
          ...
          <TableBody items={bookMappingListData}>
            {(item) => (
...
export default BookMappingList;
