      ...
      >
        ...
        <div className="h-full overflow-y-auto flex flex-col justify-between">
          <ul className='flex flex-col'>
            ...
            <li>
              <Link href={'/super-admin/book-upload'} className={`text-base font-normal flex items-center gap-3 p-4 border-l-4 border-transparent ${pathname.startsWith('/super-admin/book-upload') ? "text-white border-white" : "text-slate-300 dark:text-zinc-400"}`}>
                <LuBookUp className='w-6 h-6'/>
                <span className={`${hideMenu ? 'hidden': ''}`}>Book Upload</span>
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href={'/super-admin/book-mapping'} className={`text-base font-normal flex items-center gap-3 p-4 border-l-4 border-transparent ${pathname.startsWith('/super-admin/book-mapping') ? "text-white border-white" : "text-slate-300 dark:text-zinc-400"}`}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25" />
                </svg>
                <span className={`${hideMenu ? 'hidden': ''}`}>Books Mapping</span>
              </Link>
            </li>
            <li>
