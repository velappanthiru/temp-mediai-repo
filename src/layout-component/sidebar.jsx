  ...
  return (
    <>
      ...
      >
        ...
        {
          userRole === 1 ?  <div className="h-full overflow-y-auto flex flex-col justify-between">
            ...
            <div className="h-full overflow-y-auto flex flex-col justify-between">
              <ul className='flex flex-col'>
                <li>
                  <Link href={'/chatbot'} className={`text-base font-normal flex items-center gap-3 p-4 border-l-4 border-transparent ${pathname?.startsWith('/chatbot') ? "text-white border-white" : "text-slate-300 dark:text-zinc-400"}`}>
                    <IoChatboxEllipsesOutline className='w-6 h-6'/>
                    <span className={`${hideMenu ? 'hidden': ''}`}>Chat Bot</span>
                  </Link>
                </li>
