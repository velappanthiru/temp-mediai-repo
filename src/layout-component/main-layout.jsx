...
const MainLayout = ({ children }) => {
  ...
  return (
    <>
      ...
      `}</style>
      <Sidebar hideMenu={sideBar} />
      <main className={`main-layout ${sideBar ? 'lg:ml-[5rem] lg:w-[calc(100%-5rem)]' : 'lg:ml-[16rem] lg:w-[calc(100%-16rem)]'} transition-all bg-[#f1f1f1] dark:bg-[#1a1d21] h-dvh overflow-y-auto`}>
